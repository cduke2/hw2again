...
role11.person_id = person1.id
role11.character_name = "Bruce Wayne"
role11.save

role12 = Role.new
role12.movie_id = movie3.id
role12.person_id = person5.id
role12.character_name = "Commissioner Gordon"
role12.save

role13 = Role.new
role13.movie_id = movie3.id
role13.person_id = person9.id
role13.character_name = "Bane"
role13.save

role14 = Role.new
role14.movie_id = movie3.id
role14.person_id = person10.id
role14.character_name = "John Blake"
role14.save

role15 = Role.new
role15.movie_id = movie3.id
role15.person_id = person11.id
...
for role in roles
    ...
    actor_in_movie = Person.where({ id: role.person_id })[0]
    puts "#{role_in_movie.title} #{actor_in_movie.name} #{role.character_name}"
end
